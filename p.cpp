...
template <typename P> struct opt {
  P p;
  template <typename U, typename = if_bark_t<U>>
  explicit opt(U &&u) noexcept : p(std::forward<U>(u)) {}
...
namespace parse::xml {
inline auto Char = cp<0x9>() | cp<0xA>() | cp<0xD>() | cp<0x20, 0xD7FF>() |
                   cp<0xE000, 0xFFFD>() | cp<0x10000, 0x10FFFF>();
auto S = run(many(cp<0x20>() | cp<0x9>() | cp<0xD>() | cp<0xA>()));
void static example() {
  ...
  auto ETag = str{""};
  auto content = str{""};
  auto CombiningChar = str{""};

  auto BaseChar =
      cp<0x41, 0x5A>() | cp<0x61, 0x7A>() | cp<0xC0, 0xD6>() |
      cp<0xD8, 0xF6>() | cp<0xF8, 0xFF>() | cp<0x100, 0x131>() |
      cp<0x134, 0x13E>() | cp<0x141, 0x148>() | cp<0x14A, 0x17E>() |
      cp<0x180, 0x1C3>() | cp<0x1CD, 0x1F0>() | cp<0x1F4, 0x1F5>() |
      cp<0x1FA, 0x217>() | cp<0x250, 0x2A8>() | cp<0x2BB, 0x2C1>() |
      cp<0x386>() | cp<0x388, 0x38A>() | cp<0x38C>() | cp<0x38E, 0x3A1>() |
      cp<0x3A3, 0x3CE>() | cp<0x3D0, 0x3D6>() | cp<0x3DA>() | cp<0x3DC>() |
      cp<0x3DE>() | cp<0x3E0>() | cp<0x3E2, 0x3F3>() | cp<0x401, 0x40C>() |
      cp<0x40E, 0x44F>() | cp<0x451, 0x45C>() | cp<0x45E, 0x481>() |
      cp<0x490, 0x4C4>() | cp<0x4C7, 0x4C8>() | cp<0x4CB, 0x4CC>() |
      cp<0x4D0, 0x4EB>() | cp<0x4EE, 0x4F5>() | cp<0x4F8, 0x4F9>() |
      cp<0x531, 0x556>() | cp<0x559>() | cp<0x561, 0x586>() |
      cp<0x5D0, 0x5EA>() | cp<0x5F0, 0x5F2>() | cp<0x621, 0x63A>() |
      cp<0x641, 0x64A>() | cp<0x671, 0x6B7>() | cp<0x6BA, 0x6BE>() |
      cp<0x6C0, 0x6CE>() | cp<0x6D0, 0x6D3>() | cp<0x6D5>() |
      cp<0x6E5, 0x6E6>() | cp<0x905, 0x939>() | cp<0x93D>() |
      cp<0x958, 0x961>() | cp<0x985, 0x98C>() | cp<0x98F, 0x990>() |
      cp<0x993, 0x9A8>() | cp<0x9AA, 0x9B0>() | cp<0x9B2>() |
      ...
      cp<0xA35, 0xA36>() | cp<0xA38, 0xA39>() | cp<0xA59, 0xA5C>() |
      cp<0xA5E>() | cp<0xA72, 0xA74>() | cp<0xA85, 0xA8B>() | cp<0xA8D>() |
      cp<0xA8F, 0xA91>() | cp<0xA93, 0xAA8>() | cp<0xAAA, 0xAB0>() |
      cp<0xAB2, 0xAB3>() | cp<0xAB5, 0xAB9>() | cp<0xABD>() | cp<0xAE0>() |
      cp<0xB05, 0xB0C>() | cp<0xB0F, 0xB10>() | cp<0xB13, 0xB28>() |
      cp<0xB2A, 0xB30>() | cp<0xB32, 0xB33>() | cp<0xB36, 0xB39>() |
      cp<0xB3D>() | cp<0xB5C, 0xB5D>() | cp<0xB5F, 0xB61>() |
      cp<0xB85, 0xB8A>() | cp<0xB8E, 0xB90>() | cp<0xB92, 0xB95>() |
      cp<0xB99, 0xB9A>() | cp<0xB9C>() | cp<0xB9E, 0xB9F>() |
      ...
      cp<0xC92, 0xCA8>() | cp<0xCAA, 0xCB3>() | cp<0xCB5, 0xCB9>() |
      cp<0xCDE>() | cp<0xCE0, 0xCE1>() | cp<0xD05, 0xD0C>() |
      cp<0xD0E, 0xD10>() | cp<0xD12, 0xD28>() | cp<0xD2A, 0xD39>() |
      cp<0xD60, 0xD61>() | cp<0xE01, 0xE2E>() | cp<0xE30>() |
      cp<0xE32, 0xE33>() | cp<0xE40, 0xE45>() | cp<0xE81, 0xE82>() |
      cp<0xE84>() | cp<0xE87, 0xE88>() | cp<0xE8A>() | cp<0xE8D>() |
      cp<0xE94, 0xE97>() | cp<0xE99, 0xE9F>() | cp<0xEA1, 0xEA3>() |
      ...
      cp<0x1167>() | cp<0x1169>() | cp<0x116D, 0x116E>() |
      cp<0x1172, 0x1173>() | cp<0x1175>() | cp<0x119E>() | cp<0x11A8>() |
      cp<0x11AB>() | cp<0x11AE, 0x11AF>() | cp<0x11B7, 0x11B8>() |
      cp<0x11BA>() | cp<0x11BC, 0x11C2>() | cp<0x11EB>() | cp<0x11F0>() |
      cp<0x11F9>() | cp<0x1E00, 0x1E9B>() | cp<0x1EA0, 0x1EF9>() |
      cp<0x1F00, 0x1F15>() | cp<0x1F18, 0x1F1D>() | cp<0x1F20, 0x1F45>() |
      cp<0x1F48, 0x1F4D>() | cp<0x1F50, 0x1F57>() | cp<0x1F59>() |
      cp<0x1F5B>() | cp<0x1F5D>() | cp<0x1F5F, 0x1F7D>() |
      cp<0x1F80, 0x1FB4>() | cp<0x1FB6, 0x1FBC>() | cp<0x1FBE>() |
      cp<0x1FC2, 0x1FC4>() | cp<0x1FC6, 0x1FCC>() | cp<0x1FD0, 0x1FD3>() |
      cp<0x1FD6, 0x1FDB>() | cp<0x1FE0, 0x1FEC>() | cp<0x1FF2, 0x1FF4>() |
      cp<0x1FF6, 0x1FFC>() | cp<0x2126>() | cp<0x212A, 0x212B>() |
      cp<0x212E>() | cp<0x2180, 0x2182>() | cp<0x3041, 0x3094>() |
      cp<0x30A1, 0x30FA>() | cp<0x3105, 0x312C>() | cp<0xAC00, 0xD7A3>();
  // Ideographic    ::=  [#x4E00-#x9FA5] | #x3007 | [#x3021-#x3029]
  auto Ideographic = cp<0x4E00, 0x9FA5>() | cp<0x3007>() | cp<0x3021, 0x3029>();
  auto Digit = cp<0x30, 0x39>() | cp<0x660, 0x669>() | cp<0x6F0, 0x6F9>() |
  ...
  auto Extender = cp<0xB7>() | cp<0x2D0>() | cp<0x2D1>() | cp<0x387>() |
                  cp<0x640>() | cp<0xE46>() | cp<0xEC6>() | cp<0x3005>() |
                  cp<0x3031, 0x3035>() | cp<0x309D, 0x309E>() |
                  cp<0x30FC, 0x30FE>();
  // Letter         ::=  BaseChar | Ideographic
  auto Letter = BaseChar | Ideographic;
  // NameChar  ::=  Letter | Digit |  '.' | '-' | '_' | ':' |  CombiningChar |
  // Extender
  auto NameChar = Letter | Digit | str{"."} | str{"-"} | str{"_"} | str{":"} |
                  CombiningChar | Extender;
  // Name      ::=  (Letter | '_' | ':') (NameChar)*
  auto Name = run(Letter | str{"_"} | str{":"}) & many(NameChar);
  // EmptyElemTag  ::=  '<' Name (S Attribute)* S? '/>'
  // auto EmptyElemTag = str("<") & Name & many(S & Attribute) & opt(S);
  auto EmptyElemTag = many(S);

  // // element       ::=  EmptyElemTag  | STag content ETag
  // auto element = EmptyElemTag | STag & content & ETag;
  // // document  ::=  prolog element Misc*
  // auto document = prolog & element & many(Misc);
}
} // namespace parse::xml
